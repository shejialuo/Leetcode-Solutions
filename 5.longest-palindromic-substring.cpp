...
private:
  ...
  /**
   * @brief We could easily save the space, because in the above
   * operation, we could only maintain one variable to maintain
   * the state.
   *
   */
...
public:
  string longestPalindrome(string s) { return longestPalindromeTwoPointer(s); }
};
// @lc code=end
